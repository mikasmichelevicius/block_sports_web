...
export default function UserAreaWidget() {
  useEffect(() => {
    let cancelled = false;
    ...
    function mount(repeat = 1) {
      ...
      w.BsportWidget.mount({
        parentElement: "bsport-widget-756263",
        companyId: 5529,
        franchiseId: null,
        dialogMode: 1,
    ...
    return () => {
      cancelled = true;
      const el = document.getElementById("bsport-widget-756263");
      if (el) el.innerHTML = "";
